...
<div>
    ...
    <div class="mt-[46px]">
        <div class="rounded-[20px] overflow-hidden p-[20px] bg-[#343444] flex flex-col">
            <div class="bg-[#7A798A] h-[290px] rounded-[20px] relative mb-[20px] w-[290px]">
                <img id="output" class="opacity-0 object-fill rounded-[20px] h-[290px] w-[290px]">
            ...
            <div class="flex justify-between mb-[17px]">
                <span  id="lblTitle" class="font-bold text-lg">{{$title}}</span>
            ...
            <div class="flex justify-between items-center mb-5">
                <div class="flex gap-x-3">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="font-bold text-[15px] text-[#EBEBEB]">{{ Auth::user()->name }}</span>
                    </div>
                </div>
                <div class="flex flex-col">
                    <span class="text-[#8A8AA0] text-[13px] font-normal">Current Bid</span>
                    <span id="lblPrice" class="text-lg font-bold">{{$price}}</span>
                </div>
            </div>
            <div class="flex justify-between items-center">
                <button class="flex border-[#5142FC] py-3 px-7 gap-x-2 border-[1px] rounded-[30px] text-sm font-bold">
                    <svg
                        width="18"
                        height="18"
                        viewBox="0 0 18 18"
