  ...
  <div>
    <div class="rounded-[20px] p-[20px] bg-[#343444] flex flex-col">
      <div class="bg-[#7A798A] h-[290px] rounded-[20px] relative mb-[20px] w-[290px]">
        <img class="object-fill h-[290px] rounded-[20px] w-[290px]" src="{{$itemImg ?? 'unknown'}}" alt="item image">
      ...
      <div class="flex justify-between mb-[17px]">
        <span class="font-bold text-lg">{{$title ?? 'unknown'}}</span>
      ...
      <div class="flex justify-between items-center">
        <div class="flex gap-x-3">
          <div class="bg-[#C4C4C4] w-[44px] h-[44px] rounded-[15px]">
            <img class="w-[44px] h-[44px] rounded-[15px] object-fill" src="{{$profilePic ?? 'unknown'}}">
          </div>
        ...
        <div class="flex flex-col">
          ...
          <span class="text-lg font-bold">€ {{$price ?? 'unknown'}}</span>
        </div>
      </div>
    </div>
  </div>
