  ...
  <div>
    <div class="rounded-[20px] p-[20px] bg-[#343444] flex flex-col">
      <div class="bg-[#7A798A] h-[290px] rounded-[20px] relative mb-[20px] w-[290px]">
          <img class="object-fill h-[290px] rounded-[20px] w-[290px]" src="{{$itemImg ?? 'unknown'}}" alt="itemimg">
          ...
          <span class="ml-[5px] font-bold text-sm">20</span>
        </div>
      </div>
      <div class="mb-[17px]">
      ...
      <div class="flex flex-col">
        <div class="flex gap-x-3">
          <div class="bg-[#C4C4C4] w-[44px] h-[44px] rounded-[15px]">
            <img class="object-fill w-[44px] h-[44px] rounded-[15px]" src="{{$profilePic ?? 'unknown'}}" alt="profile">
          </div>
          <div class="flex flex-col">
            <span class="text-[#8A8AA0] text-[13px] font-normal">Creator</span>
            <span class="font-bold text-[15px] text-[#EBEBEB]">{{$userName ?? 'unknown'}}</span>
          </div>
        </div>
        <hr class="mb-4 mt-5 border-[#14141F]">
        <div class="flex flex-col">
          <span class="text-[#8A8AA0] text-[13px] font-normal">Price</span>
