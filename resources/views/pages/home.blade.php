...
@section('pages')
  ...
  <section class="bg-[#14141F] py-20 flex px-[255px] flex-col justify-center">
    ...
    <div class="flex gap-x-[20px] gap-y-7 mb-20 flex-wrap">
      @foreach($collections as $collection)
        <x-collections :items="$collection->items" :collection-name="$collection->name" :user-name="$collection->user->name" :profile-pic="$collection->user->getFirstMediaUrL('ProfilePic')"/>
      @endforeach
    </div>
    <div>
