...
@section('pages')
  ...
  <main class="bg-[#14141F] pt-[117px] pb-[80px] isolate flex pl-[255px] pr-[260px] relative flex-col">
    <div class="flex flex-col">
      ...
      <span class="text-[56px] font-bold"><span class="text-[56px] text-[#E250E5] font-bold">Monster </span>NFTs</span>
    ...
    <div class="flex gap-x-4 mb-[230px] mt-[36px]">
      <a href="/explore" class="py-[17px] flex px-9 rounded-[30px] gap-x-2 border-[#5142FC] border font-bold text-[15px]">
        <svg
          width="21"
          height="24"
          viewBox="0 0 21 24"
    ...
    <div class="relative mt-10">
      ...
      <div class="flex gap-x-[30px] overflow-x-scroll">
        @foreach($items as $item)
          <x-home-cards :item-img="$item->getFirstMediaUrL('items_images')" :item-title="$item->title" :user-id="$item->user->name" :item-price="$item->price" :profile-pic="$item->user->getFirstMediaUrL('ProfilePic')"/>
        @endforeach
      </div>
    </div>
  </section>
  <section class="bg-[#14141F] py-20 flex px-[255px] flex-col justify-center">
      ...
      <div class="bg-[#343444] p-[20px] rounded-[10px]">
        <div class="flex gap-2.5 mb-[10px]">
          <div class="bg-[#7A798A] w-[200px] h-[131px] rounded-[10px]">
            <img class="w-[200px] h-[131px] rounded-[10px] object-fill" src="#" alt="#">
          </div>
          <div class="bg-[#7A798A] h-[131px] w-[200px] rounded-[10px]">
            <img class="h-[131px] w-[200px] rounded-[10px] object-fill" src="#" alt="#">
          </div>
        </div>
        <div class="flex gap-2.5 mb-[20px]">
          <div class="bg-[#7A798A] w-[130px] h-[131px] rounded-[10px]">
            <img class="w-[130px] h-[131px] rounded-[10px] object-fill" src="#" alt="#">
          </div>
          <div class="bg-[#7A798A] w-[131px] h-[131px] rounded-[10px]">
            <img class="w-[131px] h-[131px] rounded-[10px] object-fill" src="#" alt="#">
          </div>
          <div class="bg-[#7A798A] w-[130px] h-[131px] rounded-[10px]">
            <img class="w-[130px] h-[131px] rounded-[10px] object-fill" src="#" alt="#">
          </div>
        ...
        <div class="gap-x-2.5 flex">
          <div class="w-[64px] h-[64px] rounded-[21px] relative bg-[#7A798A]">
            <img class="w-[64px] h-[64px] rounded-[21px] object-fill" src="#" alt="profile">
    ...
    <div>
      <span class="text-[36px] font-bold">Top Users</span>
      <div class="flex flex-wrap gap-y-7 mt-10 mb-20 gap-x-16 max-w-[1415px]">
         @foreach($users as $user)
          <x-sellers :user-name="$user->name" :profile-pic="$user->getFirstMediaUrL('ProfilePic')"/>
          @endforeach
      </div>
    </div>
    ...
    <div class="flex flex-wrap gap-x-[30px] gap-y-10 max-w-[1415px]">
      @foreach($items as $item)
        <x-users-cards :item-id="$item->id" :item-img="$item->getFirstMediaUrL('items_images')" :item-title="$item->title" :user-id="$item->user->name" :item-price="$item->price" :profile-pic="$item->user->getFirstMediaUrL('ProfilePic')"/>
      @endforeach
    </div>

    <div class="flex justify-center">
      <button class="text-[15px] font-bold py-4 px-10 border-[1px] rounded-[30px] mt-[40px]">Load More</button>
    </div>
  </section>
